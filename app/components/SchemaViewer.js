...
export default function SchemaViewer() {
  ...
  const getTypeIcon = (type) => {
    ...
    if (lowerType.includes('real') || lowerType.includes('float') || lowerType.includes('double')) return '🔢';
    return '📄';
  };
  ...
  const getTypeColor = (type) => {
    ...
    if (lowerType.includes('real') || lowerType.includes('float') || lowerType.includes('double')) return 'text-indigo-600 bg-indigo-50';
